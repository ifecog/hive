"""
CLI entry point for Research Agent X.
...
from .agent import default_agent, ResearchAgentX
...
def cli():
    """Research Agent X - Interactive, rigorous research with TUI conversation."""
    pass
...
def tui(verbose, debug):
    ...
    async def run_with_tui():
        agent = ResearchAgentX()

        # Build graph and tools
        agent._event_bus = EventBus()
        agent._tool_registry = ToolRegistry()

        storage_path = Path.home() / ".hive" / "agents" / "research_agent_x"
